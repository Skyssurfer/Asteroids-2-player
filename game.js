function game(){ 
  ...
  for (var i = 0; i < asteroids.length; i++) {
    if (timerValue >= 2.5 && ship.hits(asteroids[i])) {
      console.log('ooops blue!');
      screen = 2;
    } else if (timerValue >= 2.5 && ship2.hits(asteroids[i])) {
  ...
  for (var e = 0; e < asteroids2.length; e++) {
    if (timerValue >= 2.5 && ship.hits(asteroids2[e])) {
      console.log('ooops blue!');
      screen = 2;
    } 
    asteroids2[e].render();
  ...
  for (var b = 0; b < asteroids3.length; b++) {
    if (timerValue >= 2.5 && ship2.hits(asteroids3[b])) {
      console.log('ooops blue!');
      screen = 3;
    } 
    asteroids3[b].render();
